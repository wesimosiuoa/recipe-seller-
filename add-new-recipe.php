                ...
                <div class="form-row">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <!-- <input type="number" class="form-control" name = "price" placeholder=" Enter price ... "> -->
                            <textarea name="description" class="form-control" cols="30" rows="5" placeholder=" Describe your recipe ... "></textarea>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <label for="">  Cooking Method  <sup style="color: red">*</sup> </label>
                            <!-- <input type="number" class="form-control" name = "price" placeholder=" Enter price ... "> -->
                            <textarea name="cookingMethod" class="form-control" cols="30" rows="5" placeholder=" Add cooking method here ... "></textarea>
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                        <div class="col">
                            <input style="color: #ffffff; font-weight: bold; background-color: green" type="submit" name="submit" class="form-control" id="submit" value=" Add Recipe">
                        </div>
                    </div>
                </div>
                <br>
